package axl.utils
{
	...
	public class U
	{
		 ...
		 */
		public static var configSubpath:String;
		...
		protected static function stageCreated(event:flash.events.Event=null):void
		{
			...
			uassets = new Assets(flashRoot.loaderInfo.url.substr(0,flashRoot.loaderInfo.url.lastIndexOf('/')));
			if(configSubpath)
			{
				uconfig = new Config(configSubpath);
				bin.trrace('CONFIG ADR', uassets.ADR);
