 ...
 */	
	...
	public class Assets
	{
		...
		public function Assets(addressPath:String)
		{
			instance = this;
			_ADR = addressPath;
		 ...
		 * In mobile apps its empty, in web apps it gets it from loaderInfo.url
		 */
		public function get ADR():String	{return _ADR }
